...
#ifdef ONLINE_JUDGE
#ifdef EXPERIMENTAL
        Options(20, 7, 0, 0.3, 0.5),
        Options(30, 7, 0, 0.3, 0.5),
        Options(40, 7, 0, 0.3, 0.5),
        Options(60, 7, 0, 0.3, 0.5),
        Options(80, 7, 0, 0.3, 0.5),
        Options(100, 7, 0, 0.3, 0.5),
        Options(200, 7, 0, 0.3, 0.5),
        Options(300, 7, 0, 0.3, 0.5),
        Options(400, 7, 0, 0.3, 0.5),
        Options(500, 7, 0, 0.3, 0.5),
        Options(750, 9, 900000, 0.3, 0.5),
#endif
        Options(20, 7, 10, 0.3, 0.5),   // 11
        Options(30, 7, 10, 0.3, 0.5),   // 10
        Options(40, 7, 10, 0.3, 0.5),   // 10
        Options(60, 7, 10, 0.3, 0.5),   // 10
        Options(80, 7, 10, 0.3, 0.5),   // 10
        Options(100, 7, 20, 0.3, 0.5),  // 11
        Options(200, 7, 20, 0.3, 0.5),  // 12
        Options(300, 7, 20, 0.3, 0.5),  // 13
        Options(400, 7, 20, 0.3, 0.5),  // 14
        Options(500, 7, 20, 0.3, 0.5),  // 15
        Options(750, 7, 1000000, 0.3, 0.5), // 40
#endif
        Options(-1, 7, 1000000, 0.3, 0.5)
};
